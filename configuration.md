...
| `suppress_file_extensions`                    | false                                                       | Supress the file extension when using the `sqlpage.link` function. Useful if behind a rewriting proxy and want to suppress urls containing `.sql`.                                                                                                                                                                                                                                                                                                                                                           |
