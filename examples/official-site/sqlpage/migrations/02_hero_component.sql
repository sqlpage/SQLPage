...
VALUES
    ...
    (
        ...
        json(
            ...
            "link_text": "Read Documentation !"},' || '{"title": "Fast", "description": "Pages load instantly, even on slow mobile networks.", "icon": "car", "color": "red", "link": "/"},' || '{"title": "Beautiful", "description": "Uses pre-defined components that look professional.", "icon": "eye", "color": "green", "link": "/"},' || '{"title": "Easy", "description_md": "You can teach yourself enough SQL to use [**SQLPage**](https://sql.datapage.app) in a weekend.", "icon": "sofa", "color": "blue", "link": "/"}' || ']'
        )
    ),
    (
        'hero',
